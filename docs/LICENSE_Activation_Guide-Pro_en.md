...
![how-to-find-update-plugin-menu](../picture/how-to-find-update-plugin-menu.png)
...
![how-to-find-search-plugin-menu](../picture/how-to-find-search-plugin-menu.png)
...
Through the latest version of the plugin, Open the **Operation Menu** and select the <span style="color: rgb(255, 76, 65);">About License</span> menu, find "Click to register the plugin" </span> link in the dialog jump to the IDE and start a trial. (Using Maven With Me Pro as an example.)

![apply-trial-license-pro](../picture/apply-trial-license-pro_en.png)
